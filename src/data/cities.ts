...
export const CITY_PAGES: CityPage[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Mnogi iz Dugog Sela prvo guglaju zagrebačke ekipe. Problem je čekanje i cijena dolaska iz grada. Mi smo s druge strane, iz zaleđa, pa nam je Dugo Selo prirodna ruta, ne izlet. Cijenu znate unaprijed: dvosjed 55 €, trosjed 70 €, kutna 90 €, tepih 10 €/m² (min. 50 €).',
      'Ako imate kutnu garnituru i tepih u dnevnom boravku, paket Dnevni boravak (kutna + fotelja + tepih do 6 m²) je 150 € umjesto 180 € zasebno. Minimalni izlazak 60 €. Pišite s adrese u Dugom Selu, javimo se brzo.',
    ],
    ...
    steps: [
      { t: 'Pošaljete WhatsApp', d: 'Napišite Dugo Selo i što treba. Ako znate kvadraturu tepiha, još bolje — cijena je 10 €/m².' },
    ...
    faq: [
      ...
      { q: 'Je li Dugo Selo stvarno bez putnog troška?', a: 'Da. Dugo Selo, Ivanić-Grad i Vrbovec su u besplatnoj zoni. Sesvete nisu — tamo je +20 € i minimum 100 €.' },
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'Križevci imaju i stare kuće s debelim tepisima i novije stanove s kutnim garniturama. I jedni i drugi se čiste istim ekstraktorom; razlika je samo u vremenu sušenja. Cijene su iste kao u Vrbovcu: nema "križevačkog dodatka". Kutna garnitura 90 €, bračni madrac 50 €, mali auto 85 €.',
      'Ako trebate i tepih u dnevnom, spojite s kaučem. Paket Dnevni boravak je 150 €. Minimalni izlazak 60 €, zato stolice i tabure ne uzimamo kao jedinu stavku. Pišite nam s Križevaca, u poruci već piše odakle ste.',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'Zelina je bliža Zagrebu nego Bjelovaru, pa ljudi često zovu zagrebačke ekipe. Nama je Zelina susjed, ne izlet: 16 km, besplatan dolazak, ista cijena kao u Vrbovcu. Tepih 10 €/m² (min. 50 €), jednokrevetni madrac 35 €, bračni 50 €.',
      'Ako ste u Bizeku, Donjoj Zelini ili prema Svetoj Heleni, i dalje ciljamo istu vožnju. Sesvete su druga priča (+20 €, min. 100 €). Zelina ostaje u besplatnoj zoni. Pišite nam, u poruci će pisati da dolazite sa stranice za Sveti Ivan Zelinu.',
    ],
    ...
    faq: [
      ...
      { q: 'Čistite li i vinske spavaće s madracem u podrumskoj etaži?', a: 'Da, madrac jednokrevetni 35 €, bračni 50 €. Treba prozračivanje; podrumi se suše sporije, to kažemo na licu mjesta.' },
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'Cesta iz Vrbovca je ravna i brza. Zato Ivanić-Grad nije "daleko da se isplati" — isplati se i za jedan trosjed (70 €) ili bračni madrac (50 €), uz minimum izlaska 60 €. Tepih mjerimo po kvadratu, 10 €/m², najmanje 50 €.',
    ...
    steps: [
      { t: 'Poruka s popisom', d: 'Npr. trosjed + tepih 6 m². To je 70 + 60 = 130 €, iznad minimuma. Paket s kutnom i foteljom je 150 €.' },
  ...
  },
  {
    ...
    body: [
      'Kloštar i Ivanić su nam jedna ruta. Ako ste u Kloštru, a susjed u Ivaniću treba fotelju, spojimo. Vama to ne mijenja cijenu: dolazak je i onako nula. Trosjed 70 €, kutna 90 €, fotelja 30 €, stolica 15 € ali samo uz nešto veće.',
      ...
      'Čazma je sljedeća na istok, isto besplatna zona. Vrbovec na sjever. Ako ste između Kloštra i Čazme, u nekom od sela uz cestu, napišite ime mjesta. Minimalni izlazak 60 €. Paket Dnevni boravak 150 € ako imate kutnu, fotelju i manji tepih.',
    ],
    ...
    faq: [
      ...
      { q: 'Čistite li i auto u dvorištu?', a: 'Da. Mali auto 85 €, limuzina/karavan 115 €, SUV/kombi 135 €. Treba struja i da auto nije na suncu u najvećoj vrućini ako se da maknuti u hlad.' },
    ],
  ...
  },
  {
    ...
    body: [
      'Čazma je mala, ali ruta je nama prirodna: Vrbovec–Kloštar–Čazma. Zato ne naplaćujemo dolazak, za razliku od Bjelovara koji je sljedeći na istok (+15 €). Ako ste u Gornjem Dragancu ili selu uz cestu prema Bjelovaru, napišite mjesto da ne pomiješamo zone.',
      'U Čazmi često radimo kuće s velikim tepisima i kutnim garniturama u dnevnom. Tepih ide 10 €/m², minimum 50 €, poštenije nego sidrenje na najnižu cijenu za mali komad. Kutna 90 €. Ako uz kutnu ide fotelja i tepih do 6 m², paket je 150 € (zasebno 180 €).',
    ...
    faq: [
      { q: 'Dolazite li i u sela oko Čazme, ne samo u centar?', a: 'Da. Napišite naselje. Sela između Čazme i Kloštra su u besplatnoj zoni. Sela koja su već bjelovarska strana mogu pasti u +15 € — to kažemo unaprijed.' },
      { q: 'Zašto je Čazma besplatna, a Bjelovar +15 €?', a: 'Čazma je ~22 km od Vrbovca, Bjelovar ~33 km i drugi smjer kad se naredaju poslovi. Cijena usluge je ista; razlika je samo putni trošak.' },
  ...
  },
  {
    ...
    accusative: 'Bjelovar',
    intro:
      'Bjelovar je županijsko središte, oko 33 km istočno od Vrbovca, pod Bilogorom. Dolazimo, uz putni trošak 15 €. Cijene usluga su iste kao u Vrbovcu; 15 € je samo dolazak, ne "bjelovarska marža".',
    body: [
      'Iz Vrbovca do Bjelovara idemo kroz Čazmu ili preko Gudovca, ovisno o satu. Rovišće i Veliko Trojstvo su na toj ruti — napišite naselje. Sam Bjelovar (centar, Novi Bjelovar, Trojstveni Markovac) je +15 € na ponudu. Minimalni izlazak i dalje 60 €, plus putni ako zbroj usluga nije veći.',
      'U Bjelovaru ima lokalnih ekipa. Mi nismo "najbliži", zato i naplaćujemo dolazak pošteno umjesto da ga sakrijemo u cijenu kauča. Dvosjed je 55 € i u Bjelovaru i u Vrbovcu. Na računu (kad obrt bude registriran) i u WhatsApp ponudi putni trošak vidite kao zasebnu stavku.',
      'Ako spajate kutnu, tepih i fotelju, paket Dnevni boravak je 150 € + 15 € dolaska. To je i dalje predvidivo. Koprivnica je slična priča (+15 €). Čazma, bliža nama, ostaje besplatna. Pišite s ove stranice da znamo da ste iz Bjelovara.',
    ],
    ...
    faq: [
      { q: 'Je li +15 € po adresi ili po komadu?', a: 'Po dolasku, jednom. Pet kauča u istoj kući i dalje imaju jedan putni trošak 15 €.' },
  ...
  },
  {
    ...
    intro:
      'Koprivnica je oko 42 km sjeveroistočno od Vrbovca, u Podravini. Dolazimo uz 15 € putnog troška. Kauč, tepih, madrac i auto čistimo na vašoj adresi; cijene usluga su iste kao kod kuće u Vrbovcu.',
    body: [
      'Ruta je Vrbovec–Križevci–Koprivnica. Zato Križevci ostaju besplatni, a Koprivnica ima ravnih 15 € dolaska, ne obračun po kilometru. Ako ste u predgrađu prema Đurđevcu ili Legradu, napišite mjesto: to već može biti izvan ove ponude, ne želimo obećati vožnju koju ne možemo držati.',
      'Koprivnica ima i stanove u novogradnji i starije kuće. Kutna garnitura 90 €, tepih 10 €/m² (min. 50 €), SUV 135 €. Putni trošak je jednom po adresi. Paket Dnevni boravak 150 € + 15 € dolaska ako točno to trebate.',
    ...
    howLead: 'Dogovorimo dan kad nam se ruta Križevci–Koprivnica složi, ili dođemo samo zbog vas uz istih 15 €. Bez skrivenih stavki.',
    steps: [
      { t: 'Poruka s Koprivnice', d: 'Popis usluga i kvart (centar, herešinec, industrija…). Odgovorimo s ukupnim iznosom uključujući 15 €.' },
    ...
    faq: [
      { q: 'Je li +15 € i za predgrađe Koprivnice?', a: 'Za samu Koprivnicu da, jednom po adresi. Sela prema Đurđevcu ili Dravi napišite pa kažemo možemo li i po kojoj cijeni. Ne obećavamo unaprijed cijelu Podravinu.' },
      ...
      { q: 'Zašto ne naplaćujete po kilometru?', a: 'Jer 0,50 €/km u Koprivnici zvuči jeftino pa naraste. 15 € je jasno. Usluga ostaje 55/70/90 za kauč, kao i svima drugima.' },
    ],
